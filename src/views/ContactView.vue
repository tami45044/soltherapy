<template>
  <div>
            ...
            <v-card-text class="pa-8">
              ...
              <v-form ref="form" v-model="valid">
                <v-row class="form-row">
                  ...
                  <v-col cols="12" sm="6" class="order-4 order-sm-3">
                    <v-text-field
                  ...
                  <v-col cols="12" sm="6" class="order-3 order-sm-4">
                    <v-text-field
          ...
          <v-card class="contact-info-card" elevation="0">
            <v-card-text class="pa-8">
              <h2 class="info-title mb-8">
                <v-icon icon="mdi-information-outline" start size="small" color="primary" />
                פרטי התקשרות
              </h2>
                  ...
                  <v-card-text class="pa-4">
                    <div class="info-item">
                      ...
                      <div class="info-content">
                        ...
                        <p class="info-text">רחוב הרצל 123, תל אביב</p>
                      </div>
                    </div>
                  </v-card-text>
                </v-card>
                  ...
                  <v-card-text class="pa-4">
                    <div class="info-item">
                      ...
                      <div class="info-content">
                        ...
                        <p class="info-text">054-123-4567</p>
                  ...
                  <v-card-text class="pa-4">
                    <div class="info-item">
                      ...
                      <div class="info-content">
                        ...
                        <p class="info-text">info@soltherapy.com</p>
              ...
              <h3 class="social-title mb-6">
                <v-icon icon="mdi-share-variant" start size="small" color="primary" />
                עקבו אחרינו
              </h3>
              <div class="social-buttons">
                <v-btn icon size="large" variant="tonal" color="primary" class="social-btn">
    ...
    <v-container fluid class="map-section pa-0">
      <div class="map-placeholder">
        <v-icon icon="mdi-map" size="64" color="primary" />
        <p class="map-text mt-4">כאן יופיע מפה של המיקום</p>
      </div>
    </v-container>
...
const faqs = [
  {
    ...
    answer:
      'אפשר לקבוע פגישה בטלפון, בווטסאפ או דרך טופס יצירת הקשר באתר. נחזור אליכם בהקדם לתיאום מועד.',
  },
  {
  ...
  },
  {
    ...
    answer: 'הפגישות מתקיימות במרפאה ברחוב הרצל 123 בתל אביב. קיימת גם אפשרות לפגישות אונליין.',
  },
  {
